...
//        $paths = explode(PATH_SEPARATOR, get_include_path());
    ...
    public static function initialize()
    {
        ...
        $logsPath = APP_PATH . "/application/logs";
    ...
    /**
     * 
     * @param \THCFrame\Module\Module $module
     * @throws \THCFrame\Module\Exception\Multiload
     */ public static function registerModule(Module $module)
    {
        if (array_key_exists($module->moduleName, self::$_modules)) {
            throw new \THCFrame\Module\Exception\Multiload(sprintf("Module %s has been alerady loaded", $module->moduleName));
        } else {
            self::$_modules[$module->moduleName] = $module;
        }
    }
    ...
    public static function _errorHandler($number, $text, $file, $row)
    {
        ...
        if (filesize(self::$_errorLog) > 5000000) {
